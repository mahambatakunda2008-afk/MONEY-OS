...
export default function AuthPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (result.data.session) { window.location.replace("/dashboard"); return; }
      setMessage(mode === "signup" ? "Account created. Check your email and open the confirmation link to finish signing in." : "No active session was returned. Please try again.");
    } catch (error) {
